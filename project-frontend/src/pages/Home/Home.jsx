                ...
                <div className="contentDesign">
                    <div className="section">
                        <div className="descriptionDesign">
                            Located in the heart of the city, InkSoul is more than just a tattoo and piercing studio; it's a sanctuary of body art where creativity meets technical skill to transform ideas into lasting masterpieces.
                            At InkSoul, we are dedicated to providing a unique and personalized experience for each client. We believe that every tattoo and piercing tells a story, and our goal is to help you tell yours in the most authentic and artistic way possible.
                        </div>
                        <img src="" alt="InkSoul Studio" className="descriptionImage" />
                    </div>
                    <div className="section">
                        <img src="" alt="InkSoul Studio" className="descriptionImage" />
                        <div className="descriptionDesign">
